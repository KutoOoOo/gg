...
namespace g
{
    ...
    { 
        ...
        //1 Доделать форму 13
        //2 Сделать в формах где добавление или редактиование обраотку исключения и формат вводимых строк
        ...
        //6 Изменить 14 форму
        //7 Сделать добавдение пользователя
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
           ...
           // if(User(textBox1.Text,textBox2.Text)==true)
            Hide();
            form2.ShowDialog();
        }
